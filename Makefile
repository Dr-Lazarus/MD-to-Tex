...
# CFLAGS = -Wall -Werror
OFILES = main.o parser.o tree.o codeblock.o headers.o paragraph.o image.o list.o node.o renderer.o iterator.o util.o cvector.o mermaid_graph.o mermaid_class_diagram.o mermaid_seq_diagram.o
